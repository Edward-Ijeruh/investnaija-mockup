      ...
      <div className="space-y-10 text-sm md:text-[15px] leading-7 text-black/70">
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc pl-5 space-y-2">
            <li>
              Ensure compliance with applicable AML/CFT/CPF laws and regulations
            </li>
            <li>
        ...
        <section className="space-y-3">
          ...
          <p>
            We conduct risk-based assessments, including enhanced due diligence
            for high-risk clients and ongoing monitoring of all accounts.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p>
            All transactions are processed through traceable electronic channels
            such as bank transfers and direct deposits.
          </p>
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li>High-risk or unverified correspondent banking relationships</li>
          </ul>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p>
            InvestNaija complies with all regulatory reporting requirements and
            submits suspicious transaction reports where necessary.
          </p>
        </section>
