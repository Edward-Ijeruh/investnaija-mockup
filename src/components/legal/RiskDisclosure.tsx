  ...
  return (
    <>
      <SEO
        ...
        description="Understand the key investment risks associated with savings, fixed income, equities, ETFs, commodities, and other financial products on InvestNaija."
        url="https://investnaija-mockup.netlify.app/legal/risk-disclosure"
      />
      <LegalLayout title="Risk Disclosure">
        <div className="space-y-10 text-sm md:text-[15px] leading-7 text-black/70">
          ...
          <section className="space-y-4">
            ...
            <p>
              All clients (existing and prospective) are advised to carefully
              read and understand the risk disclosures contained in this
              document before making any investment decisions.
            </p>

            <p>
              Investing involves risk, including the possible loss of capital.
              The value of your investments may rise or fall, and you may
              receive back less than your original investment.
            </p>
          ...
          <section className="space-y-3">
            ...
            <p>
              ...
              of financial instruments. It affects all asset classes and cannot
              be eliminated completely.
            </p>

            <p>
              Key drivers include interest rates, equity prices, commodity
          ...
          <section className="space-y-3">
            ...
            <p>
              When interest rates rise, bond prices typically fall. When
              interest rates fall, bond prices typically rise.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              Commodity prices may fluctuate due to supply and demand
              conditions, affecting both producers and buyers.
            </p>
          ...
          <section className="space-y-3">
            ...
            <p>
              InvestNaija works with regulated systems to help reduce exposure
              to counterparty failures where applicable.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              Political and regulatory changes can significantly impact
