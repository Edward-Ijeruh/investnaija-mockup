...
import hourGlass from "../../assets/planin/hour-glass.png";

export default function PlanINLearn() {
  return (
        ...
        <div className="grid md:grid-cols-2 gap-14 items-center">
          ...
          >
            <div className="relative">
              <img
                src={hourGlass}
                alt="PlanIN retirement planning"
          ...
          >
            ...
            <p className="mt-6 text-sm md:text-base text-black/60 leading-relaxed">
              Join Adaora and thousands of others in the ultimate challenge to
              become multi-millionaires by 65 without breaking a sweat through
