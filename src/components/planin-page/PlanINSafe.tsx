...
import safeImg from "../../assets/planin/safe.png";

export default function PlanINSafe() {
  return (
        ...
        <div className="grid md:grid-cols-2 gap-14 items-center">
          ...
          >
            ...
            <p className="mt-6 text-sm md:text-base text-black/60 leading-relaxed">
              Sleep soundly, knowing your funds are secure and accessible
